            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('home')}}">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="logo-text ms-2 d-none d-sm-block">Zero One</h5>
                    </div>
                </div>
            </a>
        </div>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown"
                    ...
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle " src="/assets/img/icons/user.svg" alt="" />
                        <!-- image profile -->
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border"
                    ...
                    <div class="card position-relative border-0">
                        ...
                        <div class="card-footer p-0 border-top border-translucent">
                            <div class="px-3">
                                <a class="btn btn-phoenix-secondary d-flex flex-center w-100 mt-2"
